...
public class EnemyBos : MonoBehaviour
{
    ...
    //[SerializeField]
    //private int _EnemyBoshp = 30;                   //ボスの体力
    ...
    ////[SerializeField]
    ////private GameObject _choicesBullet;            //選択肢攻撃用の箱
    ////[SerializeField]
    ////private GameObject _choicesNoBullet;          //攻撃用の箱

    //private Vector2 pos;                            //座標
    //public int _enemyBos = 1;                       //エネミーの数
    ...
    //public static EnemyBoss _enemyBosScripts;        //どこでもスクリプトを呼び出すため
    //void Start()
    //{
    ...
    //    //左右移動
    //    transform.Translate(transform.right * Time.deltaTime * _Speed * _enemyBos);
    ...
    //        //計算処理
    //        _EnemyBoshp -= Critical;
    //        Debug.Log("クリティカルhp" + _EnemyBoshp);
    //        //全て終わったらフラグを戻す
    //        criticalCount = false;
    //    }
